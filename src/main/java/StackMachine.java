...
public class StackMachine {
    ...
    private final HashMap<Object, Object> variables;
    ...
    public void process(){
        while (this.pos < this.poliz.size()){
            ...
            if (stackHead.equals("!")){
                this.pos = Integer.parseInt(this.stack.remove(this.stack.size() - 1).toString());
            } else if (stackHead.equals("!F")){
                int addr = Integer.parseInt(this.stack.remove(this.stack.size() - 1).toString());
                if (!Boolean.parseBoolean(this.stack.remove(this.stack.size() - 1).toString()))
                    this.pos = addr;
    ...
    private void getSize(Object objRef) {
        if(objRef instanceof LinkedList) {
    ...
    private void mul(Object a, Object b) {
        this.stack.add(Integer.parseInt(a.toString()) * Integer.parseInt(b.toString()));
    }
    ...
    private void equal(Object a, Object b) {
        this.stack.add(Integer.valueOf(a.toString()).equals(Integer.valueOf(b.toString())));
    }
